...
class View:
        ...
        coregister_layout = [[
            ...
            sg.Column([
                ...
                [sg.Column([
                    ...
                    [sg.Text("Rescale:"),
                     sg.InputText(readonly=True, key="rescale-x", size=(10,15)),
                     sg.InputText(readonly=True, key="rescale-y", size=(10,15)),
                     sg.InputText(readonly=True, key="rescale-z", size=(10,15))],
                    [sg.Text("Translation:"),
    ...
    def popup_color_chooser(look_and_feel=None):
        ...
        grid = [[ColorButton(list(color_map.items())[c + j * row_len]) for c in range(0, row_len)] for j in
                range(0, num_colors // row_len)]
        grid += [[ColorButton(list(color_map.items())[c + num_colors - num_colors % row_len]) for c in
                  range(0, num_colors % row_len)]]
